...
project = 'Cisco RADKIT Ansible Collection'
copyright = 'Cisco'
title = 'Cisco RADKIT Ansible Collection Documentation'
html_short_title = 'Cisco RADKIT Ansible Collection Documentation'
