...
+==============================+=============+===========+===============+==============+==========+=====================+
| **ssh_proxy + network_cli**  | Excellent   | No        | No SCP        | Remote       | High     | **Recommended**     |
+------------------------------+-------------+-----------+---------------+--------------+----------+---------------------+
| **port_forward**             | Good        | Excellent | Full SCP/SFTP | Local        | Medium   | **Recommended**     |
+------------------------------+-------------+-----------+---------------+--------------+----------+---------------------+
| **terminal** (deprecated)    | No          | Basic     | Limited       | Remote       | High     | **Deprecated**      |
+------------------------------+-------------+-----------+---------------+--------------+----------+---------------------+
| **network_cli** (deprecated) | Good        | No        | No            | Remote       | High     | **Deprecated**      |
+------------------------------+-------------+-----------+---------------+--------------+----------+---------------------+
| **http_proxy**               | No          | No        | No            | Local        | Medium   | Active              |
+------------------------------+-------------+-----------+---------------+--------------+----------+---------------------+
| **Command/Genie modules**    | Specialized | No        | No            | Remote       | High     | Active              |
+------------------------------+-------------+-----------+---------------+--------------+----------+---------------------+
