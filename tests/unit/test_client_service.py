...
class TestRadkitClientService(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.valid_params = {
            ...
            'client_key_password_b64': base64.b64encode(b'test-password').decode('utf-8'),
    ...
    def test_exec_command_return_full_response(self, mock_version_check: Mock) -> None:
        ...
        result = service.exec_command('show version', mock_inventory, return_full_response=True)
